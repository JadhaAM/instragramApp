...
<View style={{ flex: 1, backgroundColor: '#333', color: '#fff', padding: 20 }}>
  ...
  <View style={{ paddingHorizontal: 20, marginTop: 10 }}>
    ...
    <TextInput style={{ paddingHorizontal: 10, marginTop: 5, paddingVertical: 5, borderWidth: 2, borderColor: '#888', borderRadius: 5, backgroundColor: '#333' }} placeholder="Username"   />
    <TextInput style={{ paddingHorizontal: 10, marginTop: 5, paddingVertical: 5, borderWidth: 2, borderColor: '#888', borderRadius: 5, backgroundColor: '#333' }} placeholder="Name"  />
    <TextInput style={{ paddingHorizontal: 10, marginTop: 5, paddingVertical: 5, borderWidth: 2, borderColor: '#888', borderRadius: 5, backgroundColor: '#333' }} placeholder="Bio"  />
